...
namespace NetLah.Extensions.Configuration.Test
{
    public class ConnectionStringManagerTest
    {
        ...
        private Mock<IDictionary<string, ProviderConnectionString>> _mockDict;
        private Mock<Func<KeyValuePair<string, string>[], Func<string, string>, ProviderName, IDictionary<string, ProviderConnectionString>>> _mockFactory;
        ...
        private IConnectionStringManager GetServiceMock(Func<string, string> keyNormalizer)
        {
            ...
            _mockDict = new Mock<IDictionary<string, ProviderConnectionString>>();
            _mockFactory = new Mock<Func<KeyValuePair<string, string>[], Func<string, string>, ProviderName, IDictionary<string, ProviderConnectionString>>>();
            _mockFactory
