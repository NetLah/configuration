...
public class ConnectionStringManagerIntegrationTest
{
    ...
    {
        return NewConfiguration(new Dictionary<string, string>
        {
    ...
    private static ConnectionStringManager GetService()
    {
        return GetService(GetConfiguration());
    }

    private static ConnectionStringManager GetService(IConfiguration configuration)
    {
        return new ConnectionStringManager(configuration);
    }

    private static Entry[] GetByProviderName(string selectProviderName)
    {
        return GetByProviderObject(selectProviderName);
    }

    private static Entry[] GetByProviderObject(object selectedProvider)
    {
        return GetArray(GetService().CloneWithProvider(selectedProvider).ConnectionStrings);
    }
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    ...
    private static void AssertAll(Entry[] allConnectionStrings)
    {
        Assert.Equal(new Entry[] {
                new("cosmos13", new ProviderConnectionString ("cosmos13", "server=cosmos13;", DbProviders.Custom, "cosmos")),
                new("COSmos14", new ProviderConnectionString ("COSmos14", "server=cosmos14;", DbProviders.Custom, "cOSMOS")),
                new("COSmos14_cOSMOS", new ProviderConnectionString ("COSmos14_cOSMOS", "server=cosmos14;", DbProviders.Custom)),
                new("defaultConnection", new ProviderConnectionString ("defaultConnection", "defaultConnection1;")),
                new("Defaultconnection_aNY", new ProviderConnectionString ("Defaultconnection_aNY", "server=any1;database=default;")),
                new("defaultConnection_cOSmOS", new ProviderConnectionString ("defaultConnection_cOSmOS", "server=cosmos1;database=default;")),
                new("MySqL10", new ProviderConnectionString("MySqL10", "server=local10;", DbProviders.MySQL)),
                new("MySqL19", new ProviderConnectionString("MySqL19", "server=local19;", DbProviders.MySQL)),
                new("MYSql20", new ProviderConnectionString("MYSql20", "server=local20;", DbProviders.MySQL)),
                new("MysQL8", new ProviderConnectionString("MysQL8", "server=local8;", DbProviders.MySQL)),
                new("MySqL9", new ProviderConnectionString("MySqL9", "server=local9;", DbProviders.MySQL)),
                new("postGREsql11", new ProviderConnectionString("postGREsql11", "server=local11;", DbProviders.PostgreSQL)),
                new("pOSTgreSQL12", new ProviderConnectionString("pOSTgreSQL12", "server=local12;", DbProviders.PostgreSQL)),
                new("postGREsql21", new ProviderConnectionString("postGREsql21", "server=local21;", DbProviders.PostgreSQL)),
                new("pOSTgreSQL22", new ProviderConnectionString("pOSTgreSQL22", "server=local22;", DbProviders.PostgreSQL)),
                new("postGREsql23", new ProviderConnectionString("postGREsql23", "server=local23;", DbProviders.PostgreSQL)),
                new("pOSTgreSQL24", new ProviderConnectionString("pOSTgreSQL24", "server=local24;", DbProviders.PostgreSQL)),
                new("Sqlserver15", new ProviderConnectionString("Sqlserver15", "server=local15;", DbProviders.SQLServer)),
                new("Sqlserver16", new ProviderConnectionString("Sqlserver16", "server=local16;", DbProviders.SQLServer)),
                new("SQLServer17", new ProviderConnectionString("SQLServer17", "type=Microsoft.Data.SqlClient;", DbProviders.SQLServer)),
                new("SQLServer18", new ProviderConnectionString("SQLServer18", "type=Microsoft.Data.SqlClient18;", DbProviders.SQLServer)),
                new("sqlserver2", new ProviderConnectionString("sqlserver2", "type=sqlserver;", DbProviders.SQLServer)),
                new("sqLServer3", new ProviderConnectionString("sqLServer3", "type=MSSQL;", DbProviders.SQLServer)),
                new("sqLSErver4", new ProviderConnectionString("sqLSErver4", "type=SQLAzure;", DbProviders.SQLServer)),
                new("SQLServer5", new ProviderConnectionString("SQLServer5", "type=System.Data.SqlClient;", DbProviders.SQLServer)),
                new("sqlSERVER6", new ProviderConnectionString("sqlSERVER6", "server=local6;", DbProviders.SQLServer)),
                new("sqLServer7", new ProviderConnectionString("sqLServer7", "server=local7;", DbProviders.SQLServer)),
            },
    ...
    public void SelectCustomNameCosmosTest(string selectProviderName)
    {
        ...
        Assert.Equal(new Entry[] {
                new("cosmos13", new ProviderConnectionString ("cosmos13", "server=cosmos13;", DbProviders.Custom, selectProviderName)),
                new("COSmos14", new ProviderConnectionString ("COSmos14", "server=cosmos14;", DbProviders.Custom, selectProviderName)),
                new("defaultConnection", new ProviderConnectionString ("defaultConnection", "server=cosmos1;database=default;", DbProviders.Custom,selectProviderName)),
            },
        connectionStrings,
        EntryComparer.Instance);
    }
    ...
    public void SelectCustomNameAnyTest(string selectProviderName)
    {
        ...
        Assert.Equal(new Entry[] {
                new("Defaultconnection", new ProviderConnectionString("Defaultconnection", "server=any1;database=default;", DbProviders.Custom, selectProviderName)),
            },
        connectionStrings,
        EntryComparer.Instance);
    }
    ...
    public void SelectMySQLTest(object selectedProvider)
    {
        ...
        Assert.Equal(new Entry[] {
                new("defaultConnection", new ProviderConnectionString ("defaultConnection", "server=mysqL1;database=default;", DbProviders.MySQL)),
                new("MySqL10", new ProviderConnectionString("MySqL10", "server=local10;", DbProviders.MySQL)),
                new("MySqL19", new ProviderConnectionString("MySqL19", "server=local19;", DbProviders.MySQL)),
                new("MYSql20", new ProviderConnectionString("MYSql20", "server=local20;", DbProviders.MySQL)),
                new("MysQL8", new ProviderConnectionString("MysQL8", "server=local8;", DbProviders.MySQL)),
    ...
    public void SelectPostgreSQLTest(object selectedProvider)
    {
        ...
        Assert.Equal(new Entry[] {
                new("defaultConnection", new ProviderConnectionString ("defaultConnection", "server=postgresql1;database=default;", DbProviders.PostgreSQL)),
                new("postGREsql11", new ProviderConnectionString("postGREsql11", "server=local11;", DbProviders.PostgreSQL)),
                new("pOSTgreSQL12", new ProviderConnectionString("pOSTgreSQL12", "server=local12;", DbProviders.PostgreSQL)),
                new("postGREsql21", new ProviderConnectionString("postGREsql21", "server=local21;", DbProviders.PostgreSQL)),
                new("pOSTgreSQL22", new ProviderConnectionString("pOSTgreSQL22", "server=local22;", DbProviders.PostgreSQL)),
    ...
    public void SelectSqlServerTest(object selectedProvider)
    {
        ...
        Assert.Equal(new Entry[] {
                new("defaultConnection", new ProviderConnectionString ("defaultConnection", "server=sqlserver1;database=default;", DbProviders.SQLServer)),
                new("Sqlserver15", new ProviderConnectionString("Sqlserver15", "server=local15;", DbProviders.SQLServer)),
                new("Sqlserver16", new ProviderConnectionString("Sqlserver16", "server=local16;", DbProviders.SQLServer)),
                new("SQLServer17", new ProviderConnectionString("SQLServer17", "type=Microsoft.Data.SqlClient;", DbProviders.SQLServer)),
                new("SQLServer18", new ProviderConnectionString("SQLServer18", "type=Microsoft.Data.SqlClient18;", DbProviders.SQLServer)),
        ...
        string name2, string name2a, string value2, DbProviders provider2, string? custom2, bool expected)
    {
        ...
        var comparer = EntryComparer.Instance;
